...
from agent08_github_a2a_agent_mcp_server.agent_engine_app import AgentEngineApp
...
def agent_app(monkeypatch: pytest.MonkeyPatch) -> AgentEngineApp:
    ...
    from agent08_github_a2a_agent_mcp_server.agent_engine_app import agent_engine
