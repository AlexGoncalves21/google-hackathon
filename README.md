...
```
google-hackathon/
├── agent08_github_a2a_agent_mcp_server/         # Core agent code
...
Edit your agent logic in `agent08_github_a2a_agent_mcp_server/agent.py` and test with `make playground` - it auto-reloads on save.
